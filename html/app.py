...
general_info = pd.read_excel(path2outline, sheet_name = "general_info")
outline = (
    pd.read_excel(path2outline, sheet_name = "outline")
    .assign(
        evenPage = lambda x: x["page"] % 2 == 0
    )
)
figure_map = pd.read_excel(path2outline, sheet_name = "figure_map")
methodological_materials_df = pd.read_excel(path2outline, sheet_name="methodological_materials")
other_publications_df = pd.read_excel(path2outline, sheet_name = "other_publications")
